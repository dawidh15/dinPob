...
\SI{5}{\milli\gram\per\second}. Además, se ha determinado que el tanque
solo soporta \SI{100}{\kilogram} de \emph{Lemna}. ¿Cuál es el tamaño de
población de \emph{Lemna} que debería haber en el tanque para maximizar
el crecimiento? ¿Cuánta biomasa debe extraer \textbf{en un día} para
mantener un máximo de crecimiento? ¿A qué biomasa total debería cosechar
la \emph{Lemna}?
\EndKnitrBlock{exercise}
...
primer paso es pasar todo a kilogramos-día.

\[
\frac{\num{5}\cancel{\si{\milli\gram}}}
{\cancel{ \si{\second} } }
\frac{\SI{1}{\kilogram}}
{\num{1000000}\cancel{\si{\milli\gram}}}
\frac{\num{86400}\cancel{\si{\second}} }{\si{\day}}= 
\frac{\SI{0.432}{\kilogram}}
{\si{\day}}
\]
