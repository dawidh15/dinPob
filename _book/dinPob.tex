...
\NormalTok{  counter <-}\StringTok{ }\NormalTok{counter }\OperatorTok{+}\StringTok{ }\DecValTok{1}
  ...
  \ControlFlowTok{if}\NormalTok{ (counter }\OperatorTok{==}\StringTok{ }\NormalTok{guardarCada) \{}
...
\KeywordTok{return}\NormalTok{(}\KeywordTok{list}\NormalTok{(}
  ...
  \DataTypeTok{Dt =}\NormalTok{ deltaT}
\NormalTok{))}
...
\NormalTok{Resultados1 <-}\StringTok{ }\KeywordTok{euler}\NormalTok{(}\DataTypeTok{fooName =} \StringTok{"diffG1"}\NormalTok{, }\DataTypeTok{valInic =}\NormalTok{ N0, }\DataTypeTok{tiempoParar =} \DecValTok{10}\NormalTok{, }\DataTypeTok{NoIter =} \DecValTok{100}\NormalTok{, }
    \DataTypeTok{guardarCada =} \DecValTok{10}\NormalTok{, }\DataTypeTok{rm =} \FloatTok{0.22}\NormalTok{)}
...
\NormalTok{Resultados2 <-}\StringTok{ }\KeywordTok{euler}\NormalTok{(}\DataTypeTok{fooName =} \StringTok{"diffG2"}\NormalTok{, }\DataTypeTok{valInic =}\NormalTok{ N0, }\DataTypeTok{tiempoParar =} \DecValTok{50}\NormalTok{, }\DataTypeTok{NoIter =} \DecValTok{500}\NormalTok{, }
    \DataTypeTok{guardarCada =} \DecValTok{50}\NormalTok{, }\DataTypeTok{rm =} \FloatTok{1.92}\NormalTok{, }\DataTypeTok{Kmax =} \DecValTok{60}\NormalTok{)}
...
\begin{figure}
\centering
\includegraphics{dinPob_files/figure-latex/numComp-1.pdf}
...
\begin{figure}
\centering
\includegraphics{dinPob_files/figure-latex/errorComp-1.pdf}
