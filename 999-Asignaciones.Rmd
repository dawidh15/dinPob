...
3. Analice el efecto de los subsidios sobre el *esfuerzo al máximo rendimiento económico sostenible* ($E_{MEY}$), sobre el *esfuerzo al máximo rendimiento social* ($E_{MSoY}$), sobre la rentabilidad de la pesquería ($TR(E)-TC(E)$) y finalmente, sobre la población cosechada.
